...
dataframe = open('path/to/mes/Abstract_New_Database.txt')



documentation_file_parameteropt = open("path/to/results/mes/parameter_optimization_tfidf_mes_finale1.txt", "w+")
documentation_file_modelopt = open(".path/to/results/mes/classifier_optimization_tfidf_mes_finale1.txt", "w+")
